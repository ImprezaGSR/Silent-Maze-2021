...
namespace LevelGenerator.Scripts
{
    public class LevelGenerator : MonoBehaviour
    {
        ...
        /// <summary>
        /// Minimum level size measured in sections
        /// </summary>
        public int MinSectionSize;
        ...
        protected void Start()
        {
            ...
            if(transform.childCount < MinSectionSize){
                gameManager.Restart();
            }
        ...
        public void SpawnChestRoom(){
            ...
            while(remaining > 0){
                int randNum = Random.Range(0,rooms.Count());
